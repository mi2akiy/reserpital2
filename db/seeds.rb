...
tokyoiin = Hospital.find_or_create_by!(name: '東京医院') do |hospital|
  hospital.hospital_image = ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{Rails.root}/db/fixtures/病院外観1.jpg"), filename: '病院外観1.jpg'
  )
...
oosakaiin = Hospital.find_or_create_by!(name: '大阪医院') do |hospital|
  hospital.hospital_image = ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{Rails.root}/db/fixtures/病院外観2.jpg"), filename: '病院外観4.jpg'
  )
  hospital.telephone_number = '0300000000'
  hospital.postal_code = '0000000'
...
nagoyaiin = Hospital.find_or_create_by!(name: '名古屋医院') do |hospital|
  hospital.hospital_image = ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{Rails.root}/db/fixtures/病院外観3.jpg"), filename: '病院外観4.jpg'
  )
  hospital.telephone_number = '0300000000'
  hospital.postal_code = '0000000'
...
fukuokaiin = Hospital.find_or_create_by!(name: '福岡医院') do |hospital|
  hospital.hospital_image = ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{Rails.root}/db/fixtures/病院外観4.jpg"), filename: '病院外観4.jpg'
  )
  hospital.telephone_number = '0300000000'
  hospital.postal_code = '0000000'
...
hyogoiin = Hospital.find_or_create_by!(name: '兵庫医院') do |hospital|
  hospital.hospital_image = ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{Rails.root}/db/fixtures/病院外観5.jpg"), filename: '病院外観5.jpg'
  )
  hospital.telephone_number = '0300000000'
  hospital.postal_code = '0000000'
...
kobeiin = Hospital.find_or_create_by!(name: '神戸医院') do |hospital|
  hospital.hospital_image = ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{Rails.root}/db/fixtures/病院外観6.jpg"), filename: '病院外観6.jpg'
  )
  hospital.telephone_number = '0300000000'
  hospital.postal_code = '0000000'
...
amagasakiiin = Hospital.find_or_create_by!(name: '尼崎医院') do |hospital|
  hospital.hospital_image = ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{Rails.root}/db/fixtures/病院外観7.jpg"), filename: '病院外観7.jpg'
  )
  hospital.telephone_number = '0300000000'
  hospital.postal_code = '0000000'
...
daimotuiin = Hospital.find_or_create_by!(name: 'だいもつ医院') do |hospital|
  hospital.hospital_image = ActiveStorage::Blob.create_and_upload!(
    io: File.open("#{Rails.root}/db/fixtures/病院外観8.jpg"), filename: '病院外観8.jpg'
  )
  hospital.telephone_number = '0300000000'
  hospital.postal_code = '0000000'
